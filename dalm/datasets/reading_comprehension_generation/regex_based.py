...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_dir', 
                        ...
                        default='/Users/gayalshamane/Documents/research-team/azure_reading_comprehension_dataset/raw_corpus')
    parser.add_argument('--output_dir', 
                        type=str, help='directory of the output reading comprehension texts', 
                        default='./data')
    parser.add_argument('--ori_spm_path',
                        type=str, help='path of the original sentencepiece model', 
                        default='./data/general.spm')
