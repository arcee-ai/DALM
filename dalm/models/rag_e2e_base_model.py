...
class AutoModelForRagE2E(torch.nn.Module):
    def __init__(self, retriever_name: str, generator_name: str, normalize: bool = True, get_peft: bool = True, use_bnb: bool = True) -> None:
    ...
    def attach_pre_trained_peft_layers(self, peft_retriever_path: str, peft_generator_path: str, device: str):
